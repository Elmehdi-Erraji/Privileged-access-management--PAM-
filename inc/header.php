...
<body>
  ...
  <div class="container">
    ...
    <nav class="navbar navbar-expand-md navbar-dark card-header" style="background-color: #0F52BA;">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <?php if (Session::get('id') == TRUE) { ?>
            <?php if (Session::get('roleid') == '1') { ?>
              ...
              <li class="nav-item">
                <a class="nav-link" href="Role.php"><i class="bi bi-plus-circle"></i> <b>+</b>Add Role </span>
                </a>
              </li>
